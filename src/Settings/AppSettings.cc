...
DECLARE_SETTINGSFACT(AppSettings, fieldModeEnabled)
DECLARE_SETTINGSFACT(AppSettings, fieldModeAllowPlan)
DECLARE_SETTINGSFACT(AppSettings, modernHudEnabled)
DECLARE_SETTINGSFACT(AppSettings, modernHudFieldDefaultApplied)
DECLARE_SETTINGSFACT(AppSettings, parameterFavorites)
DECLARE_SETTINGSFACT(AppSettings, namedFloatsToShow)
DECLARE_SETTINGSFACT(AppSettings, parameterFavoritesCopterDefaults)
DECLARE_SETTINGSFACT(AppSettings, parameterFavoritesPlaneDefaults)
DECLARE_SETTINGSFACT(AppSettings, parameterFavoritesRoverDefaults)
