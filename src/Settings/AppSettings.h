...
public:
    ...
    DEFINE_SETTINGFACT(fieldModeEnabled)
    DEFINE_SETTINGFACT(fieldModeAllowPlan)
    DEFINE_SETTINGFACT(modernHudEnabled)
    DEFINE_SETTINGFACT(modernHudFieldDefaultApplied)
    DEFINE_SETTINGFACT(parameterFavorites)
    DEFINE_SETTINGFACT(namedFloatsToShow)
    DEFINE_SETTINGFACT(parameterFavoritesCopterDefaults)
    DEFINE_SETTINGFACT(parameterFavoritesPlaneDefaults)
    DEFINE_SETTINGFACT(parameterFavoritesRoverDefaults)
